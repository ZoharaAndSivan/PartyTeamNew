    ...
    <>
      <div>
        <a href="managerHomePage">
          <img src={ourlogo} alt="managerHomePage" />
        </a>
      </div>
      <nav className="navv">
        <div className="wraps">
          <div className="aas">
            <Link to="eventApprovals" className="dropbtn">
              אישורי אירועים{" "}
            </Link>
          </div>
          ...
          <div className="aas">
            <Link to="aboutedit" className="dropbtn">
              עריכת אודות{" "}
            </Link>
          </div>
          <Link to={"statictics"} className="dropbtn">
            {" "}
            סטטיסטיקות
          </Link>
          <div className="dropdown">
            ...
            {props.user ? (
              <Link to="updateMyProfil" className="aas">
                {" "}
                My Profil
              </Link>
            ) : null}

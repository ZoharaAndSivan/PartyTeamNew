...
function Navbar(props) {
    ...
    return (
        <>
            <div><a href="homePage"><img src={ourlogo} alt="homePage" /></a></div>
            <nav className="navv">
                <div className="wraps">
                    <div className="aas"><Link to="addEvent" className="dropbtn">יצירת אירוע</Link></div>
                        ...
                        <div className="dropdown">
                            ...
                            <div className="dropdown-content">
                                {c.typeEvents.length != 0 && c.typeEvents.map(te =>
                                    <Link to="/list" onClick={() => goToList(te.Id)}>{te.Name} </Link>)
                                }
                            </div>
                        </div>
                    )}
                    <div className="aas"><Link to="about" className="dropbtn">אודות </Link></div>
                    <div className="dropdown">
                        ...
                        <div className="dropdown-content">
                            <Link to="register" className="d">הרשמה</Link>
                            <Link to="login" className="d">התחברות</Link>
                        </div>
                    </div>
                </div>
            </nav>
...
export default connect(mapStateToProps, { getListByTypeAction })(Navbar);